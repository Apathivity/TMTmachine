module.exports = {
	...
	config: {
		name: '🔶',
		description: 'Flags a course submission as Gold',
		usage: 'large_orange_diamond',
		category: 'TMT',
		accessableby: 'TMT',
		aliases: [],
	},
	...
	run: async (bot, reaction, user, lvlMod) => {
		...
		catch (error) { console.error('Orange_Diamond -', error); }
		...
		// reaction.message.channel.send('Orange_Diamond');
